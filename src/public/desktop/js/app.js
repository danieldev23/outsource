                    ...
                    if (t != null) {
                        ...
                        switch (t.Error.Code) {
                            case ApiStatusCodeEnum.Unauthorized:
                                i.Alert(
                                    "",
                                    u || SweetAlertTypeEnum.none, !1,
                                    i.ChangeLanguage("閒置過久已將您登出，請重新登錄"),
                                    null,
                                    function() {
                                        r == null ?
                ...
                (i.SetLocalStorageItem = function(n, t, i, r) {
                    return typeof Storage != "undefined" ?
                        (r != null &&
                            ...
                            localStorage.getItem(n) || localStorage.setItem(n, t), !0) :
                        !1;
                }),
    ...
    e = (function() {
        ...
        return (
            ...
            (t.IsVerifyTimesOverLimit = function(n) {
                return n.indexOf(
                        i.ChangeLanguage("您今日驗證次數已達上限，請聯繫客服")
                    ) >= 0 ||
                    n.indexOf(
                        i.ChangeLanguage("您今日驗證次數已達上限，請聯繫客服專員!")
                    ) >= 0 ||
                    n.indexOf(
                        i.ChangeLanguage("您今日找回密碼次數已達上限，請聯繫客服專員")
                    ) >= 0 ?
                    !0 :
                    !1;
            }),
    ...
    var t = (function() {
        ...
        return (
            (t.prototype.IsAccountNameFormatValid = function(n) {
                return (
                    this.IsVietnamWordValid(n) && /^[A-Za-z.'’\x20]{0,50}$/.test(n)
                );
            }),
            ...
            (t.prototype.ChkDeliveryAddress = function(t, i) {
                ...
                return (
                    ...
                    ((t.Address && t.Address !== "") ||
                        ...
                        ((r.Valid = !1),
                            (r.Message = n.Helpers.ChangeLanguage("請輸入收貨地址"))),
                        (t.ProvincesID && t.ProvincesID !== 0) ||
                        (i != DeliveryAddressTypeEnum.Unspecified &&
                            i != DeliveryAddressTypeEnum.ProvincesID) ||
                        ((r.Valid = !1),
                            (r.Message = n.Helpers.ChangeLanguage("請選擇省分")))) :
                    (u = {
                        ProvincesID: 0,
                        CityID: 0,
                        DistrictID: 0,
                    ...
                    ((i.Valid = !0),
                        ...
                        ((i.Valid = !1),
                            (i.EventError.Address =
                                n.Helpers.ChangeLanguage("請輸入寄送地址"))),
                        (t.CityID && t.CityID !== 0) ||
                        ((i.Valid = !1),
                            (i.EventError.CityID =
                                n.Helpers.ChangeLanguage("請選擇城市"))),
                        (t.ProvincesID && t.ProvincesID !== 0) ||
                        ((i.Valid = !1),
                            (i.EventError.CityID =
                                n.Helpers.ChangeLanguage("請選擇省分"))),
                        (t.ProvincesID && t.ProvincesID !== 0) ||
                        (t.CityID && t.CityID !== 0) ||
                        ((i.Valid = !1),
                            (i.EventError.CityID =
                                n.Helpers.ChangeLanguage("請選擇省份及城市")))) :
                    (i = {
                        Valid: !1,
                        EventError: {
                            Address: "",
                            CityID: n.Helpers.ChangeLanguage("請選擇省份及城市"),
                        },
                    }),
                    i
                );
                        ...
                        return {
                            ...
                            link: function(n, t) {
                                t.keypress(function(n) {
                                    ...
                                    r || t.tooltip("show"): r && t.tooltip("hide");
                                });
                                t.blur(function() {
                                    t.tooltip("hide");
                                });
                        ...
                        return {
                            ...
                            link: function(t, i, r) {
                                var s = i.attr("id") || i.attr("name"),
                                    ...
                                    h = r.ckFor || null;
                                f != null &&
                                    (e.push("uploadimage"), $.extend(u, {
                                        imageUploadUrl: f
                                    }));
                                o != null && $.extend(u, {
                                    filebrowserImageUploadUrl: o
                                });
                                $.extend(u, {
                                    extraPlugins: e.toString(),
                                    imageUploadUrl: f
                                });
                                    ...
                                    if (t.Enable) {
                                        ...
                                        if (!/^[0-9]*[1-9][0-9]*$/.test(t.Sec + "")) {
                                            n.Helpers.Alert(
                                                "",
                                                SweetAlertTypeEnum.none, !1,
                                                n.Helpers.ChangeLanguage("請填寫刷新時間")
                                            );
                                            t.Enable = !1;
                                            return;
                                        }
                                        if (t.Sec < 10) {
                                            n.Helpers.Alert(
                                                "",
                                                SweetAlertTypeEnum.none, !1,
                                                n.Helpers.ChangeLanguage("刷新時間需大於10秒")
                                            );
                                            t.Enable = !1;
                                            return;
                                        }
                                            ...
                                            t.Sec == 0 ?
                                                ...
                                                ((t.Sec -= 1),
                                                    ...
                                                    (h(r, {
                                                        ...
                                                        n.Helpers.Notify(
                                                            n.Helpers.ChangeLanguage("資料已刷新"),
                                                            NotifyTypeEunm.info
                                                        )));
                                        }, 1e3);
                                        e = !0;
                                    ...
                                    var i = u.culture,
                                        ...
                                        .catch(function() {
                                            n.Helpers.Alert(
                                                "",
                                                SweetAlertTypeEnum.none, !1,
                                                n.Helpers.ChangeLanguage("轉換語系發生問題")
                                            );
                                        });
                                };
                                r.on("click", f);
                    ...
                    (t.DirectiveFactory = function(t, i, r, u) {
                        return (
                            u.On("OnInitMarquee", function() {
                                ...
                                restrict: "A",
                                template: '<span ng-repeat="data in ::datas" on-repeat-last="OnInitMarquee" ng-bind-html="::data.NewsContent" op-width="800px" op-height="600px" open-window="/Announcement/Announcement?NewsId={{data.NewsID}}&Category=0" op-name="PersonalMessage" class="first-span"></span>',
                                link: function(u) {
                                    var f = Array(),
                                        e = t
                                        ...
                                        var r = function(t) {
                                            ...
                                            if (
                                                ...
                                                n.Helpers.Alert(
                                                    "",
                                                    SweetAlertTypeEnum.none, !1,
                                                    n.Helpers.ChangeLanguage("請先完成補充資料填寫"),
                                                    null,
                                                    function() {
                                                        jQuery.fancybox(i);
                                                    }
                                            ...
                                            if (
                                                ...
                                                if (o.UserProfile.MemberPlatformBlackList.length == 0) {
                                                    n.Helpers.Alert(
                                                        "",
                                                        SweetAlertTypeEnum.none, !1,
                                                        n.Helpers.ChangeLanguage("查詢有效服務列表發生問題")
                                                    );
                                                    return;
                                                }
                                                if (
                                ...
                                var c = function(t) {
                                    ...
                                    if (o.LoginStatus !== n.Models.LoginStatusEnum.WaitingLogIn) {
                                        ...
                                        if (
                                            ...
                                            if (
                                                h.enableProtect === "true" && [1, 2].some(function(n) {
                        ...
                        var r = !1,
                            u = function(t) {
                                ...
                                i
                                    ...
                                    ((r = !1),
                                        n.Helpers.Notify(
                                            n.Helpers.ChangeLanguage("該瀏覽器不支持此操作"),
                                            NotifyTypeEunm.info
                                        ),
                        ...
                        return {
                            ...
                            link: function(i, f, e) {
                                ...
                                nt = function() {
                                    ...
                                    o.src = e.sliderImage;
                                    i.tips = b ?
                                        n.Helpers.ChangeLanguage("請重新嘗試") :
                                        n.Helpers.ChangeLanguage("向右滑動填充拼圖");
                                };
                            },
                        };
                    }),
