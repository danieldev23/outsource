...
function(n) {
    ...
    (function(n) {
        var t = function() {
            ...
            return n.prototype.GetDBAConfigMemberPaymemtBySettingType = function() {
            ...
            }, n.$name = "LoginSvc", n.$inject = ["DataProvider"], n
        }();
        n.LoginSvc = t
    })(t = n.Services || (n.Services = {}))
}(OBSMobileApp || (OBSMobileApp = {}));
OBSMobileApp.RegisterAngular.RegisterService(OBSMobileApp.Services.LoginSvc.$name, OBSMobileApp.Services.LoginSvc),
    function(n) {
        var t;
        (function(t) {
            var i = function() {
                ...
                return t.prototype.InitializeViewModel = function() {
                    ...
                    this.messageBus.On("NeedSetProtectCode", function(n, i) {
                        ...
                        i.NeedSetProtectCode || (r = function() {
                ...
                }, t.prototype.RegisterValidation = function() {}, t.prototype.ShowLogIn = function() {
                    ...
                    this.loginSvc.GetDBAConfigMemberPaymemtBySettingType().then(function(t) {
                        if (t === !0) {
                            window.location.href = jQuery("#registerurl").val();
                            return
                        }
                        n.Helpers.Alert(n.Helpers.ChangeLanguage("網站維護中，無法進行註冊"), SweetAlertTypeEnum.warning)
                    }).catch(function(t) {
                        n.Helpers.Alert(n.Helpers.ChangeLanguage(t.Error.Message), SweetAlertTypeEnum.error)
                    })
                    ...
                    n.Helpers.SetLocalStorageItem(n.ConstDefinition.LocalStorageKey.ImportantNewsID, this.ImportantNewsItem.NewsID, !0);
                    $("#importantNews").hide()
                    ...
                    this.loginSvc.GetDrawEventSettingAll().then(function(i) {
                ...
                }, t.$name = "LoginCtrl", t.$inject = ["$timeout", "LoginSvc", "PermissionSvc", "$cookies", "messageBus"], t
            }();
            t.LoginCtrl = i
        })(t = n.Controllers || (n.Controllers = {}))
    }(OBSMobileApp || (OBSMobileApp = {}));
OBSMobileApp.RegisterAngular.RegisterController(OBSMobileApp.Controllers.LoginCtrl.$name, OBSMobileApp.Controllers.LoginCtrl),
    function(n) {
        var t;
        (function(n) {
            var t = function() {
        ...
        (function(t) {
            var i = function() {
                ...
                return t.prototype.RegisterValidation = function() {}, t.prototype.InitializeViewModel = function(t) {
                    return this.model = new n.Models.CaptchaCodePanelViewModel, t && (this.model.Options = t), this.model.DefaultCountDownSecond = Number(jQuery("#hfDefaultCountDownSecond").val()), this.SetAmazingSign(), this.GetVerifyModeEvent()
                    ...
                    return this.captchaCodePanelSvc.CheckProtectCodeServiceCallBackReturnCaptchaCode({
                        ...
                        (r == "NOT=0" || r == "NOT=1") && (r == "NOT=0" && (t.model.CloseResult.LockCallCustomerService = !0), t.model.IsCallCustomerService = !0, t.model.CloseResult.IsCallCustomerService = !0, n.Helpers.Alert("", SweetAlertTypeEnum.none, !1, n.Helpers.ChangeLanguage("客服人員將致電與您聯繫，請您留意接聽電話") + t.model.DoubleAmazingSign), i.resolve(!0));
                    ...
                    return this.captchaCodePanelSvc.CheckDisposableServiceCallBackReturnCaptchaCode({
                        ...
                        (r == "NOT=0" || r == "NOT=1") && (r == "NOT=0" && (t.model.CloseResult.LockCallCustomerService = !0), n.Helpers.Alert("", SweetAlertTypeEnum.none, !1, n.Helpers.ChangeLanguage("客服人員將致電與您聯繫，請您留意接聽電話") + t.model.DoubleAmazingSign), i.resolve(!0));
        ...
        (function(t) {
            var i = function() {
                function t(t, i, r, u, f, e, o, s) {
                    ...
                    this.transferBlockStartOption = {
                        overrideOverlayClass: "block_ui_overlay_game_transfer"
                    };
                ...
                return t.prototype.SetLinkDisabled = function(n) {
                    ...
                    this.$timeout(function() {
                        ...
                        var i = $("#transferAmount, .btn_transfer, .btn_transAll");
                        n ? (t.isDisabled = !0, $(".btn_transfer, .btn_transAll").attr("disabled", "disabled").css("cssText", "background-color:#bbb !important;color:white !important;"), $("#transferAmount").attr("disabled", "disabled").removeClass("on")) : (i.removeAttr("disabled style"), t.isDisabled = !1, t.displayAmount.MainAmount != "0" ? ($(".btn_transfer, .btn_transAll").removeAttr("disabled style"), $("#transferAmount").focus()) : t.displayAmount.MainAmount == "0" && ($(".btn_transfer, .btn_transAll").attr("disabled", "disabled").css("cssText", "background-color:#bbb !important;color:white !important;"), $("#transferAmount").attr("disabled", "disabled").css("cssText", "background-color:#e5e5e5 !important;color:white !important;").removeClass("on")))
                    })
                    ...
                    var n = this;
                    this.$timeout(function() {
                        n.transferAmount = null;
                        $(".mask,.mask_join,.mask_all").hide();
                        n.footerMenuSelections.PlatfromTransfer.active = !1;
                    ...
                    return $(".container_main").css({
                        position: "fixed",
                        top: "-" + r + "px"
                    }), $(".btn_footer_fast").addClass("active"), this.CloseDWZone(), i = this.$q.defer(), t = new n.Models.FooterPlatformTransfer, t.ToGameType = this.gameType, t.FromGameType = "Member", t.TransferAmount = 1, this.footerSvc.CheckTransferPopup(t).then(function() {
                        i.resolve(!0)
                    }).catch(function(t) {
                        if (i.reject(!1), $(".btn_footer_fast").removeClass("active"), t.Error.Code === 4001 || t.Error.Code === 1004) n.Helpers.AlertSwitch(t);
                ...
                }, t.prototype.CheckTransferPopup = function() {
                    var i = this,
                        t = new n.Models.CheckTransferPopupPostModel;
                    t.FromGameType = this.gameType;
                    t.ToGameType = "Member";
                    t.TransferAmount = 1;
                    this.footerSvc.CheckTransferPopup(t).then(function() {}).catch(function() {
                        i.transferAmount = null;
                        i.ShowErrorMsgOnInputAmount(!1);
                        i.ControlTransferPanel(!0)
                    })
                    ...
                    return i = new n.Models.FooterGameLobbyModel, i.GameType = this.gameType, i.SubGameType = this.subGameType, i.TransferAmount = this.transferAmount, this.transferBlock.start(this.transferBlockStartOption), this.ControlTransferPanel(!0), this.footerSvc.TransferPoint(i).then(function() {
                        t.transferAmount = null;
                        $(".keyboard").removeClass("keyIn textMoney").css("color", "#999");
                        ...
                        t.transferBlock.stop()
                    }), !0
                }, t.prototype.TransferGameAllPointToMainAccount = function() {
                    var t = this,
                        i = new n.Models.FooterGameLobbyModel;
                    return i.GameType = this.gameType, this.transferBlock.start(this.transferBlockStartOption), this.ControlTransferPanel(!0), this.footerSvc.TransferGamePointToMain(i).then(function() {
                        t.transferAmount = null;
                        t.GetMainAmountAndGameBalance();
                        t.UpdateLoginAreaGameBalance();
                        n.Helpers.NotifyBox(n.Helpers.ChangeLanguage("轉點成功"), null, null, 1e3)
                    ...
                    var t = this;
                    return this.transferBlock.start(this.transferBlockStartOption), this.ControlTransferPanel(!0), this.footerSvc.TransferGamesPointToMain().then(function(i) {
                        if (t.transferAmount = null, t.GetMainAmountAndGameBalance(), t.UpdateLoginAreaGameBalance(), i.Data.Message === n.Helpers.ChangeLanguage("您的可轉餘額為0")) {
                            n.Helpers.Alert("", SweetAlertTypeEnum.none, !1, i.Data.Message);
                            return
                        }
                        n.Helpers.NotifyBox(n.Helpers.ChangeLanguage("轉點成功"), null, null, 1e3)
                    }).catch(function(n) {
                        return t.CatchProcess("allGames", n)
                    }).finally(function() {
                        t.transferBlock.stop()
                    }), !0
                    ...
                    if (i.Error.Code === 1002) {
                        if (t === "allGames") {
                            ...
                            this.UpdateLoginAreaGameBalance();
                            return
                        }
                    ...
                    i.Error.Code === 4018 ? (this.appContextSvc.StopCheckInterval(), $("#GameLobbyFastTransfer").hide(), $("#GameLobbyFastTransferLogOut").show()) : i.Error.Code === 5999 ? ($("#GameLobbyFastTransfer").hide(), $("#GameLobbyFastTransferLogOut").show()) : (this.ControlTransferPanel(!1), n.Helpers.AlertSwitch(i))
                ...
                }, t.$name = "FooterCtrl", t.$inject = ["appConfig", "appContext", "$q", "$timeout", "messageBus", "FooterSvc", "AppContextSvc", "blockUI"], t
            }();
            t.FooterCtrl = i
        })(t = n.Controllers || (n.Controllers = {}))
    }(OBSMobileApp || (OBSMobileApp = {}));
        ...
        (function(t) {
            var i = function() {
                function t(t, i, r, u, f, e, o, s, h, c, l) {
                    ...
                    location.pathname.toLowerCase().indexOf("/game/electgame") !== -1 || location.pathname.toLowerCase().indexOf("/game/sportgame") !== -1 ? (p = n.Helpers.GetLocalStorageItem(n.ConstDefinition.LocalStorageKey.GameGroupID), p && (this.activeMenu = p, this.appContext.LoginStatus !== n.Models.LoginStatusEnum.Loggedin && n.Helpers.DeleteLocalStorageItem(n.ConstDefinition.LocalStorageKey.GameGroupID))) : n.Helpers.DeleteLocalStorageItem(n.ConstDefinition.LocalStorageKey.GameGroupID)
                }
                return t.prototype.InitializeViewModel = function() {
                    ...
                    }), e) ? (n.Helpers.Alert("", SweetAlertTypeEnum.none, !1, e.Message), this.ControlTransferPanel(!1), this.ShowErrorMsgOnInputAmount(!1), !0) : (u = "", f = "", t === "-8888888888" && (this.ControlAccountPanel(GameStatusEnum.isBusy), u = n.Helpers.ChangeLanguage("繁忙中"), f = n.Helpers.ChangeLanguage("系統繁忙請稍候")), t === "-9999999999" && (u = f = n.Helpers.ChangeLanguage("載入中"), r && (this.ControlAccountPanel(GameStatusEnum.isBusy), u = n.Helpers.ChangeLanguage("繁忙中"), f = n.Helpers.ChangeLanguage("系統繁忙請稍候"))), !u && !f) ? !1 : (this.ControlTransferPanel(!0), this.ShowErrorMsgOnInputAmount(!0, null, u), i && n.Helpers.Alert("", SweetAlertTypeEnum.none, !1, f), !0)
                }, t.prototype.InitializeQuickTransfer = function(n, t, i) {
                    return t === void 0 && (t = ""), i === void 0 && (i = ""), this.ControlTransferPanel(!0), this.gameType = n, this.subGameType = t, this.gameRedirectType = i, this.ShowErrorMsgOnInputAmount(!1), this.ControlAccountPanel(GameStatusEnum.isLoading), this.GetMasterAccountBalance(), (this.gameType === "BB_LiveGame" || this.gameType === "BB_Ball" || this.subGameType === "TS_Sport" || this.subGameType === "NBBSport") && this.GetAnchorBalance(), this.tick = this.$interval(this.WaitForGetAllbalance.bind(this), 100, 0, !0, null, "interval"), !0
                    ...
                    }), f.length === 0) ? !1 : (r === "JZNBBSport" && (n = "JZNBBSport"), e = ".GameList_R.swiper-slide-active", (n === "SM" || n === "SMForum") && (e = ".popupCI"), u = $(e).find("#" + n + "_personal_maintain"), f[0].BlackStatus === "0") ? (o = $(window).scrollTop(), $(".container_main").css({
                        position: "fixed",
                        top: "-" + o + "px"
                    ...
                    return i.GameType = this.gameType, i.SubGameType = this.subGameType, this.transferBlock.start(this.transferBlockStartOption), this.ControlTransferPanel(!0), this.gameAreaSvc.TransferPoint(i).then(function() {
                    ...
                    return n.Formatter.GetNumberData(this.model.MasterAccountBalanceModel.BalanceAmount) === 0 ? (n.Helpers.Alert("", SweetAlertTypeEnum.none, !1, n.Helpers.ChangeLanguage("主帳戶餘額不足")), !1) : this.gameType === "OBLive" && n.Formatter.GetNumberData(this.model.MasterAccountBalanceModel.BalanceAmount) < 5 && (n.SiteCultureMethod.Provider().LanguageCode.toLowerCase() == "vi-vn" || n.SiteCultureMethod.Provider().LanguageCode.toLowerCase() == "th-th") ? (r = n.SiteCultureMethod.Provider().LanguageCode.toLowerCase() == "vi-vn" ? "," : "", u = "<span>" + n.Helpers.ChangeLanguage("轉帳金額低於限制") + r + "<\/span><br><span>" + n.Helpers.ChangeLanguage("請轉入5點以上") + "!<\/span><br/>", n.Helpers.Alert("", SweetAlertTypeEnum.none, !1, u, null, function() {
                        t.ShowKeyboardTransferAndCleanAccount()
                    }), !1) : (i.GameType = this.gameType, i.SubGameType = this.subGameType, this.transferBlock.start(this.transferBlockStartOption), this.ControlTransferPanel(!0), this.gameAreaSvc.TransferMainAllAmountToGame(i).then(function() {
                    ...
                    if (["CQNineFishing", "DSFishing", , "KYFishing", "LCFishing", "OBFish"].some(function(t) {
                            return t === n.subGameType
                        })) {
                        this.OpenGame();
                        return
                    }
                    if (["BB_Ball", "BB_LiveGame", "NBB", "TS", "DDD", "BNG", "CQNine", "DS", "DT", "FC", "Joker", "KS", "KY", "LC", "PG", "PLS", "RKFive", "VR", "OBEgame", "OBChess"].some(function(t) {
                            return t === n.gameType
                        })) {
                        this.RedirectToGame();
                        return
                    ...
                    this.timeout(function() {
                        ...
                        var r = $(".transferAmount, .btn_popupW50L, .btn_popupW100, .btn_enterGame");
                        n ? (i.model.TransferDivShowModel.CheckTransferShow = 0, i.model.TransferDivAllTransferShowModel.CheckTransferShow = 0, $(".btn_popupW50L, .btn_popupW100, .btn_enterGame").attr("disabled", "disabled").css("cssText", "background-color:#aaa !important;color:#fff !important;"), $("#FastTransferAmount").attr("disabled", "disabled").removeClass("on"), t && $(".btn_popupW50L, .btn_popupW100, .btn_enterGame").removeAttr("disabled style"), $(".btn_transfer, .btn_transAll").attr("disabled", "disabled").css("cssText", "background-color:#aaa !important;color:white !important;")) : i.model.MasterAccountBalanceModel.IsAvailable && i.model.GameAccountBalanceModel.IsAvailable ? (r.removeAttr("disabled style"), $("#FastTransferAmount").removeAttr("disabled style"), i.model.MasterAccountBalanceModel.BalanceAmount != "0" ? ($(".btn_transfer, .btn_transAll").removeAttr("disabled style"), $("#FastTransferAmount").focus(), i.model.TransferDivAllTransferShowModel.CheckTransferShow = 1, i.model.TransferDivShowModel.CheckTransferShow = 1) : i.model.MasterAccountBalanceModel.BalanceAmount == "0" && $("#FastTransferAmount").attr("disabled", "disabled").css("cssText", "background-color:#e5e5e5 !important;color:white !important;")) : (i.model.TransferDivShowModel.CheckTransferShow = 0, i.model.TransferDivAllTransferShowModel.CheckTransferShow = 0, r.attr("disabled", "disabled").css("cssText", "background-color:#aaa !important;color:#fff !important;"), $(".btn_transfer, .btn_transAll").attr("disabled", "disabled").css("cssText", "background-color:#aaa !important;color:white !important;"), $("#FastTransferAmount").css("cssText", "background-color:#e5e5e5 !important;color:white !important;"))
                    })
                    ...
                    if (i.Error.Code === 4008) this.model.TranscationPostModel.TransferAmount = null, n.Helpers.Alert("", SweetAlertTypeEnum.none, !1, i.Error.Message, null, function() {
                        r.fancyclose();
                        window.location.reload(!0)
                    });
                    else {
                        ...
                        if (i.Error.Code === 4015) n.Helpers.Alert("", SweetAlertTypeEnum.none, !1, i.Error.Message, null, function() {
                        ...
                        else if (i.Error.Code === 1004) this.model.TranscationPostModel.TransferAmount = null, n.Helpers.AlertSwitch(i), this.ShowErrorMsgOnInputAmount(!1), this.ControlTransferPanel(!0, !0);
                        else {
                            if (i.Error.Code === ApiStatusCodeEnum.TransferPointCommonError) {
                                u = n.Helpers.ChangeLanguage("轉點失敗");
                                n.Helpers.ChangeLanguage(i.Error.Message) === n.Helpers.ChangeLanguage("代理商金額不足") ? (n.Helpers.Alert("", SweetAlertTypeEnum.none, !1, n.Helpers.StringFormat(n.Helpers.ChangeLanguage("【{0}】與【{1}】互轉失敗，請聯繫客服！"), n.Helpers.ChangeLanguage("主帳戶"), this.ChangePlatformName(t)), null, function() {
                            ...
                            if (i.Error.Code === 4010) this.fancyclose(), this.$fasttransferMaintainBox.show();
                            else {
                                ...
                                i.Error.Code === 4001 ? (this.model.TranscationPostModel.TransferAmount = null, n.Helpers.Alert("", SweetAlertTypeEnum.none, !1, i.Error.Message, null, function() {
                                    r.fancyclose();
                                    window.location.reload(!0)
                ...
                }, t.$name = "GameAreaCtrl", t.$inject = ["GameAreaSvc", "$window", "messageBus", "blockUI", "$q", "$timeout", "appContext", "appConfig", "$cookies", "$interval", "AppContextSvc"], t
            }();
            t.GameAreaCtrl = i
        })(t = n.Controllers || (n.Controllers = {}))
    }(OBSMobileApp || (OBSMobileApp = {}));
    ...
    function(n) {
        ...
        (function(n) {
            var t = function() {
                ...
                return n.$name = "LoginLockPopupSvc", n.$inject = ["DataProvider"], n
            }();
    ...
    function(n) {
        ...
        (function(t) {
            var i = function() {
                ...
                return t.prototype.InitializeViewModel = function() {
                ...
                }, t.prototype.RegisterValidation = function() {}, t.prototype.AccountLockClose = function() {
                    this.blockUI.start();
                    ...
                    this.blockUI.start();
                    n.NavigationHelper.GetInstance().RedirectPageToSecondLevel(t, i)
                }, t.$name = "LoginLockPopupCtrl", t.$inject = ["$scope", "$q", "$interval", "$timeout", "LoginLockPopupSvc", "blockUI", "messageBus"], t
            }();
                ...
                return t.prototype.InitializeViewModel = function() {
                    ...
                    return this.login.ElementManager.IsEnabled("signin") ? (this.blockUI.start(), this.login.ElementManager.DisableElementBy("signin", "DoSignIn"), r = angular.copy(this.login), r.AccountPWD = this.toolsSvc.Base64Encode(r.AccountPWD), r.LocalStorgeCookie = n.Helpers.GetLocalStorageItem(n.ConstDefinition.LocalStorageKey.IT), r.ScreenResolution = screen.width + "*" + screen.height, r.CaptchaCode = r.ProtectCodeModel.CaptchaCode, r.ProtectCodeModel.PWD != "" && (r.ProtectCode = this.toolsSvc.Base64Encode(r.ProtectCodeModel.PWD)), r.ProtectCodeModel.CellPhone != "" && (r.ProtectCodeCellPhone = r.ProtectCodeModel.CellPhone), Fingerprint2.get(function(u) {
                        ...
                        i.loginPopupSvc.SignIn(r).then(function(t) {
                            ...
                            r.Error.Code != ApiStatusCodeEnum.RefreshSliderCaptcha && r.Error.Code != ApiStatusCodeEnum.RefreshSliderCaptchaPhone && (r.Error.Code === ApiStatusCodeEnum.SignInFailedOverLimit || r.Error.Code === ApiStatusCodeEnum.AccountIsForbiddenToLogin ? (i.login.SignInOverLimitErrorMsg = r.Error.Message, $("#loginLock").show()) : i.login.ShowPhoneVerify || i.login.ShowSliderCaptcha ? n.Helpers.Alert("", SweetAlertTypeEnum.none, !1, r.Error.Message) : (jQuery("#frmLogin .login_list").addClass("errorPW_login"), jQuery("#errorPW").text(r.Error.Message), jQuery("#errorPW").attr("style", "display: block;")));
                            i.needSetProtectCode || (i.login.AccountID = "", i.login.CellPhone = "", i.login.AccountPWD = "");
                            i.blockUI.stop();
                            i.login.ElementManager.EnableElementBy("signin", "DoSignIn");
                            t.reject(!1)
                        })
            ...
            var i = function() {
                ...
                return t.prototype.InitializeViewModel = function() {
                    ...
                    if (i) {
                        ...
                        this.model.PointsControlCenter.GameAvailableList = _.uniqBy(this.model.PointsControlCenter.GameAvailableList, function(n) {
                            return n.GameID
                        });
                        this.$timeout(function() {
        ...
        (function(t) {
            var i = function() {
                ...
                return t.prototype.RegisterValidation = function() {}, t.prototype.CloseIcon = function(t) {
                    ...
                    t.on("mousemove touchmove", c);
                    t.on("mousedown touchstart", l)
                }, t.$name = "RaffleTicketIconCtrl", t.$inject = ["$timeout"], t
            }();
    ...
    function(n) {
        ...
        (function(t) {
            var i = function() {
                ...
                return t.prototype.RegisterValidation = function() {}, t.prototype.CloseIcon = function(n) {
                    n.stopPropagation();
                    ...
                    location.href = n
                }, t.$name = "SuperPlayIconCtrl", t.$inject = ["$timeout"], t
            }();
